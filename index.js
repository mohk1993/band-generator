...
app.post("/submit", (req, res) => {
  ...
  var randomAdj = Math.floor((Math.random() * (adj.length -1)) + 1)
  var randomNoun = Math.floor((Math.random() * (noun.length -1)) + 1)

  res.render("index.ejs", {adj: adj[randomAdj], noun: noun[randomNoun]})
});
